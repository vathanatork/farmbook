...
import { useAdminEdit } from "../../../hooks/admin/useEdit";

export const ResetPasswordForm = ({open,handleOpen,resetID,setOpenDialog,setAlert,setAlertMessage}) => {
  ...
  const { data:editData , isSuccess:editIsSuccess, refetch: editRefetch } = useAdminEdit(formData,resetID?.[0]);
